        ...
        */
        ...
        private List<GameObject> GetNeighbors(Point point)
        {
            ...
            foreach (var direction in directions)
            {
                ...
                Cell newPointCell = cells[newPoint].GetComponent<Cell>() as Cell;
                ...
                if (Math.Abs(point.X - nx) == 1 && Math.Abs(point.Y - ny) == 1)
                {
                    ...
                    Cell side1Cell = cells[sidePoint1].GetComponent<Cell>() as Cell;
                    Cell side2Cell = cells[sidePoint2].GetComponent<Cell>() as Cell;
